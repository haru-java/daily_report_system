/*
Lesson 17Chapter 5.2
Actionクラスのスーパークラスを作成

すべてのActionクラスのスーパークラスとなるクラス。
従業員管理機能では EmployeeAction、日報管理機能では ReportAction というように、いくつかActionクラスを作成。
その際、どのActionでも必要になる処理は、スーパークラスである ActionBase で実装。
 */
